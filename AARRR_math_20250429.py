...
#%%
# 회고
# 프로젝트를 진행하는 동안 헤깔리는 부분도 많았고 멈춰지는 상황도 많이 발생하였습니다.
# 이에 아직 많이 부족했음을 깨달았으며 더욱 학습이 필요하는 것도 알았습니다.
# 다만, 프로젝트를 완성했다는 점, 여러 자료의 도움을 받았지만 문제를 해결했다는 점에서는 잘하였다고 생각합니다.
# 앞으로도 더욱 많고 새로운 것들을 학습 할 테지만, 하나하나 쌓아가며 더욱 성장하는 제가 되겠습니다.
